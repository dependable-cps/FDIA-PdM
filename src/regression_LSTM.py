...
train_df = pd.read_csv('../../Dataset/PM_train1.txt', sep=" ", header=None)
...
test_df = pd.read_csv('../../Dataset/myDataS1N.txt', sep=" ", header=None)
...
truth_df = pd.read_csv('../../Dataset/myDataTrue.txt', sep=" ", header=None)
